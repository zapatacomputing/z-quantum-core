...
two_qubit_parametric_gates_amplitudes_test_set = [
    ...
    [["I", "H"], "XY", [-np.pi / 2], [0.5 * np.sqrt(2), 0.5 * np.sqrt(2) * 1.0j, 0, 0]],
    ...
    [["H", "I"], "XY", [-np.pi / 2], [0.5 * np.sqrt(2), 0, 0.5 * np.sqrt(2) * 1.0j, 0]],
    ...
    [
        ...
        "XY",
        [-np.pi / 2],
        [0.500000000000000, 0.5 * 1.0j, 0.5 * 1.0j, 0.500000000000000],
    ],
    [
        ["H", "H"],
        "XY",
    ...
    [
        ...
        [
            0.500000000000000,
            0.125 + 0.125 * np.sqrt(5) - 0.5 * 1.0j * np.sqrt(5 / 8 - np.sqrt(5) / 8),
            0.125 + 0.125 * np.sqrt(5) - 0.5 * 1.0j * np.sqrt(5 / 8 - np.sqrt(5) / 8),
            0.500000000000000,
        ],
    ],
