...
PYQUIL_GATES = ['I', 'X', 'Y', 'Z', 'H', 'S', 'T', 'PHASE', 'RX', 'RY', 'RZ', 'CZ', 
                'CNOT', 'CCNOT', 'CPHASE00', 'CPHASE01', 'CPHASE10', 'CPHASE', 'SWAP', 
                'CSWAP', 'ISWAP', 'PSWAP', 'WAIT', 'RESET', 'NOP', 'HALT', 'MEASURE', 
                'TRUE', 'FALSE', 'NOT', 'AND', 'OR', 'MOVE', 'EXCHANGE', 'IOR', 'XOR', 
                'NEG', 'ADD', 'SUB', 'MUL', 'DIV', 'EQ', 'GT', 'GE', 'LE', 'LT', 'LOAD', 
                'STORE', 'CONVERT', 'Gate']

# All gates natively supported in cirq
CIRQ_GATES = ['PhasedXPowGate', 'CNOT', 'CNotPowGate', 'CZ', 'CZPowGate', 'H', 'HPowGate', 
              'ISWAP', 'ISwapPowGate', 'measure', 'measure_each', 'MeasurementGate', 'XPowGate', 
              'YPowGate', 'ZPowGate', 'Rx', 'Ry', 'Rz', 'S', 'SWAP', 'SwapPowGate', 'T', 'X', 'Y', 
              'Z', 'XX', 'XXPowGate', 'YY', 'YYPowGate', 'ZZ', 'ZZPowGate', 'PhasedXPowGate',
              'CCX', 'CCXPowGate', 'CCZ', 'CCZPowGate', 'CSWAP', 'CSwapGate', 'FREDKIN', 'TOFFOLI']
